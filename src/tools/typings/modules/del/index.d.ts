...
declare module '~del~pinkie-promise~es6-promise' {
...
declare module '~del~pinkie-promise' {
import { Promise } from '~del~pinkie-promise~es6-promise';
...
declare module 'del' {
import Promise = require('~del~pinkie-promise');
